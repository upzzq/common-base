package com.xbd.svc.common.service;
...
public class SnowflakeIdWorkerGenerator implements IdGenerator {
    ...
    public static void main(String[] args) {
        ...
        SnowflakeIdWorkerGenerator idWorker = new SnowflakeIdWorkerGenerator(0, 0);
        int index = 0;
        for (int i = index; index < 4000000; index++) {
        ...
        System.out.println("index : " + index + "结束："+ (end - start) / 1000);
    }
}
